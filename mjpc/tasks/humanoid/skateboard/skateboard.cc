#include "mjpc/tasks/humanoid/skateboard/skateboard.h"
...
std::string Skateboard::XmlPath() const {
  return GetModelPath("humanoid/skateboard/task.xml");
}
std::string Skateboard::Name() const { return "Humanoid Skateboard"; }
