...
#include "mjpc/tasks/humanoid_phc/tracking/tracking.h"
...
namespace mjpc::humanoid_phc {

std::string Tracking::XmlPath() const {
  return GetModelPath("humanoid_phc/tracking/task.xml");
}
std::string Tracking::Name() const { return "HumanoidPHC Track"; }

// ----------- Residuals for PHC humanoid tracking task -----------
//   Number of residuals:
