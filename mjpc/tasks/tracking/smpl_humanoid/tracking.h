...
#ifndef MJPC_TASKS_TRACKING_SMPL_HUMANOID_TRACKING_H_
#define MJPC_TASKS_TRACKING_SMPL_HUMANOID_TRACKING_H_

#include <mujoco/mujoco.h>
#include "mjpc/task.h"

namespace mjpc {
namespace smpl_humanoid {
...
#endif  // MJPC_TASKS_TRACKING_SMPL_HUMANOID_TRACKING_H_
